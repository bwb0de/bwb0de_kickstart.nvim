...
vim.api.nvim_create_user_command("ErrMsg", function()
  vim.cmd('read ~/.config/nvim/templates/C_nvim_error.c') end, {
})

vim.api.nvim_create_user_command("Err", function()
  vim.cmd('read ~/.config/nvim/templates/C_nvim_error_test.c') end, {
})

vim.api.nvim_create_user_command("Main", function()
  vim.cmd('read ~/.config/nvim/templates/C_nvim_main.c') end, {
})

vim.api.nvim_create_user_command("Rand", function()
  vim.cmd('read ~/.config/nvim/templates/C_nvim_rand.c') end, {
})
...
vim.api.nvim_create_user_command("Malloc", function()
  vim.cmd('read ~/.config/nvim/templates/C_nvim_malloc.c') end, {
})

vim.api.nvim_create_user_command("Slice", function()
  vim.cmd('read ~/.config/nvim/templates/C_nvim_slice.c') end, {
})
...
vim.api.nvim_create_user_command("SwitchLine", function()
  vim.cmd('read ~/.config/nvim/templates/C_nvim_switch_line.c') end, {
})

vim.api.nvim_create_user_command("Switch2", function()
...
vim.api.nvim_create_user_command("InputInclude", function()
  vim.cmd('read ~/.config/nvim/templates/C_nvim_input_info.c')
  vim.cmd('0read ~/.config/nvim/templates/C_nvim_input_include_iocli.c') end, {
})
